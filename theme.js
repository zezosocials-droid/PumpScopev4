...
index 8b137891791fe96927ad78e64b0aad7bded08bdc..55e31211be7fbb5c630f47c8d7241ca42e073ff0 100644
--- a/theme.js
+++ b/theme.js
@@ -1 +1,43 @@
+(function(){
...
+
+  window.ensureLogin = () => {
+    const authed = localStorage.getItem('pumpscope_authed');
+    if(authed !== 'true' && !location.pathname.endsWith('login.html')){
